...
// Mapeia stats para labels curtos
...
// Exibe comparação lado-a-lado de stats com barras coloridas
  ...
  return (
    <div className="compare-stats-container">
      {p1.stats.map((s1: PokemonStat, index: number) => {
        ...
        // Valor máximo entre os dois para escalar as barras proporcionalmente
